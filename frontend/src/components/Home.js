            ...
            <div className="row">
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 text-center">
                ...
                >
                  ...
                  <p className="description text-right">
                    بنوفرلك عيادات خارجية شاملة جميع التخصصات تحت إشراف صفوة من
                    كبار الاستشاريين والأخصائيين في جميع التخصصات
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 text-center">
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 text-center">
                ...
                >
                  ...
                  <p className="description text-right">
                    نسعى دائما لتقديم كل الرعاية والاهتمام لمرضانا مع وجود فريق
                    طبي متميز لتطبيق أعلى المعايير
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 text-center">
            ...
            <div className="row">
              ...
              >
                ...
                <p className="description2 text-center">
                  ...
                  الاستشاريين والأخصائيين في جميع التخصصات و تشمل عياداتنا عيادة
                  الباطنة - عيادة النساء والتوليد - عيادة الاسنان - عيادة العظام
                  - عيادة الجلدية و التجميل - عيادة أنف و أذن و حنجرة - عيادة
                  اطفال - عياده الجراحة - عيادة رمد - اكبر واضخم مركز علاج طبيعي
                  متكامل بغرب الاسكندرية - معمل تحاليل طبية متكامل - مركز اشعة
                  مجهز باحدث اجهزة الاشعة الديجتال
                </p>
                <br />
                <br />
                <ul>
            ...
            <ul className="faq-list text-right">
              ...
              <li>
                ...
                <div id="faq3" className="collapse" data-bs-parent=".faq-list">
                  <p>
                    يقوم الفريق الطبي بأحدث إجراءات السامة الخاصة بفيروس كورونا
                    المستجد{" "}
                  </p>
                </div>
              </li>
